...
RUN apt-get update
RUN apt-get install wget git clang g++ cmake mingw-w64 mingw-w64-x86-64-dev mingw-w64-tools mingw-w64-common mingw-w64-i686-dev gcc-mingw-w64 build-essential wget unzip build-essential cmake autotools-dev git clang mingw-w64 libcapstone-dev libssl-dev cowsay mono-devel -y
